...
```
**Note: Users at this point should point to an HTML file.**
...
**Note: you will need to create this route.**
- In your routes file, create a users.js file, inside of it, you will need to include:
...
You could also add a route to send a response of req.user to get information about the user.
